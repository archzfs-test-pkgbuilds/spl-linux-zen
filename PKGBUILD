...
pkgver=0.7.9.4.17.5.1
pkgrel=1
makedepends=("linux-zen-headers=4.17.5-1")
arch=("x86_64")
...
license=("GPL")
depends=("spl-utils-common=0.7.9" "kmod" "linux-zen=4.17.5-1")
...
package_spl-linux-zen-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/spl-*/4.17.5-1-zen/Module.symvers
}
