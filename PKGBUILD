...
pkgrel=1
makedepends=("linux-zen-headers=4.18.4.zen1-1")
arch=("x86_64")
...
license=("GPL")
depends=("spl-utils-common=0.7.9" "kmod" "linux-zen=4.18.4.zen1-1")
prepare() {
    cd "${srcdir}/spl-0.7.9"
...
package_spl-linux-zen-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/spl-*/4.18.4-zen1-1-zen/Module.symvers
}
